    ...
    <?php if(isset($_SESSION['success'])) { ?>
        ...
        <div class="block-content block-content-full">
            ...
            <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                ...
                <tbody>
                    <?php $i=1; foreach($obj->getUserInfo('staff') as $key => $row) { ?>
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="btn-group">
                            <a href="delete-user.php?id=<?=$row['uid']?>&type=staff" class="btn btn-sm " data-toggle="tooltip" title="One tap delete"
