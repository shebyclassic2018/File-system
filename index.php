<?php session_start(); require 'pages/inc/_global/config.php'; ?>
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-4 py-4">
                        ...
                        <div class="text-center">
                            ...
                            <h2 class=" h4 text-muted mb-3">
                                MZUMBE UNIVERSITY STUDENT FILE SYSTEM (MUSFS)
                            </h2>
                        </div>
                        <!-- END Header -->
                            ...
                            <div class="py-3">
                                ...
                                <div class="form-group">
                                    <div class="d-md-flex align-items-md-center justify-content-md-between">
                                        ...
                                        <a class="font-size-sm" href="signup.php">I don't have account (For student)</a>
                                        </div>
                                        <div class="py-2">
