...
<main id="main-container">
    ...
    <?php if(isset($_SESSION['success'])) { ?>
        ...
        <div class="block-content block-content-full">
            ...
            <form action="backend/new-user.php?user=staff" class="pad-15" method="POST">
                <div class="row">
                ...
                <div class="row ">
                    ...
                    <div class="col-xs-12 col-md-2">Designation</div>
                    <div class="col-xs-12 col-md-2 ">
                    <select name="des_id" class="form-control">
                            <option value="none">--Choose--</option>
                            <?php foreach($obj->getDesignation() as $row) {?>
                ...
                <div class="row ">
                    <div class="col-xs-12 col-md-2">Department</div>
                    <div class="col-xs-12 col-md-2 ">
