...
<main id="main-container">
    ...
    <div class="block pad-lr-15" width="100%">
        <form method="POST" action="backend/add-department.php" class="row">
            <div class="col-md-5"><span class="txt-muted">Add new department</span></div>
            <div class="col-md-2">
                <label for="pid">Department</label>
                <input class="form-control" type="text" id="pid" name="dep">
            </div>
            <div class="col-md-2">
            ...
            <div class="col-md-2">
                ...
                <select class="form-control" type="text" id="abbr" name="faculty_id">
                    <option disabled>-- Choose --</option>
                    <?php foreach ($obj->getFaculty() as $row) { ?>
    ...
    <div class="bg-body-black">
        <div class="content content-full">
            <div class="content-heading"><span class="fa fa-list"></span> REGISTERED DEPARTMENTS</div>
        </div>
    </div>

    <!-- Dynamic Table with Export Buttons -->
    <div class="block">
        <div class="alert alert-warning"><b>NOTE:</b><br>Once you delete a department will also delete the programmes
            relates to it</div>
        <div class="block-content block-content-full">
            <div class="table-responsive">
                ...
                <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                    ...
                    <tbody>
                        <?php $i=1; foreach($obj->getDepartment() as $key => $row) { ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <a href=""><?=$obj->countProgrammeDepartmentId($row['id'])?></a>
                            </td>


                            <td class="text-center">
                                <div class="btn-group">
                                    <a href="delete-department.php?id=<?=$row['id']?>" class="btn btn-sm "
