...
<main id="main-container">
    ...
    <div class="block pad-lr-15" width="100%">
        <form method="POST" action="backend/add-programme.php" class="row">
            <div class="col-md-5"><span class="txt-muted">Add new programme</span></div>
            <div class="col-md-2">
                <label for="pid">Programme</label>
                <input class="form-control" type="text" id="pid" name="prog">
            </div>
            <div class="col-md-2">
            ...
            <div class="col-md-2">
                ...
                <select class="form-control" type="text" id="abbr" name="dep_id">
                    <option disabled>-- Choose --</option>
                    <?php foreach ($obj->getDepartment() as $row) { ?>
    ...
    <div class="bg-body-black">
        <div class="content content-full">
            <div class="content-heading"><span class="fa fa-list"></span> REGISTERED PROGRAMMES</div>
        </div>
    </div>
                ...
                <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                    <thead>
                        <tr>
                            ...
                            <th class="d-sm-table-cell">Programme</th>
                            <th class="d-sm-table-cell">Abbreviation</th>
                            <th>Action</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php $i=1; foreach($obj->getProgramme() as $key => $row) { ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="btn-group">
                                    <a href="delete-programme.php?id=<?=$row['id']?>" class="btn btn-sm "
