<title>File System for custodian of registry</title>
<style>
.std-info td{
    ...
    <nav id="sidebar" aria-label="Main Navigation" style="background: #333;color: white">
        ...
        <div class="content-side content-side-full">
            <ul class="nav-main">
                ...
                <li class="nav-main-item">
                    <a class="nav-main-link" href="staff-inbox.php">
                ...
                <?php } ?>
                <li class="nav-main-item">
                    <a class="nav-main-link" href="std-file.php">
                        <i class="nav-main-link-icon si si-folder"></i>
                        <span class="nav-main-link-name">Student files</span>
                    </a>
                </li>

                <?php if($_SESSION['role'] == 'custodian') { ?>
                <li class="nav-main-item">
                    <a class="nav-main-link" href="std-certificate.php">
                        <i class="nav-main-link-icon si si-folder"></i>
                        <span class="nav-main-link-name">Review certificates</span>
                    </a>
                </li>
                <?php } ?>
