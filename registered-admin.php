        ...
        <div class="block-content block-content-full">
            <div class="table-responsive">
                ...
                <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                    ...
                    <tbody>
                        <?php $i=1; foreach($obj->getUserInfo('admin') as $key => $row) { ?>
                        <tr>
                            ...
                            <!-- <td class="text-center">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-sm" data-toggle="tooltip" title="Grant"
                                        style="background: transparent">
                                        <i class="fa fa-fw fa-check-circle"></i>
                                    </button>
                                    <button type="button" class="btn btn-sm" data-toggle="tooltip" title="Revoke"
                                        style="background: transparent">
                            ...
                            <td class="text-center">
                                <div class="btn-group">
                                    <a href="delete-user.php?id=<?=$row['uid']?>&type=admin" class="btn btn-sm "
